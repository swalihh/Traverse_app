      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              "Welcome to Traverse! We value your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and disclose the information you provide when you use our Traverse mobile application (\"App\"). By using the App, you consent to the practices described in this policy.",
          style: TextStyle(color: Colors.white),
           ...
           style: TextStyle(color: Colors.white), ),
            ...
            SizedBox(height: 16),
            Text(
              "If you have any questions, concerns, or requests regarding this Privacy Policy, please contact us at Traverseapp@gmail.com. We are here to assist you and address any privacy-related inquiries you may have.",
            style: TextStyle(color: Colors.white),
            ),
            SizedBox(height: 16),
          ],
